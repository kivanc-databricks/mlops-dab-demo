...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/mlops-dab-demo-tests-ci.yml)
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-mlops-dab-demo-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-mlops-dab-demo-model)
