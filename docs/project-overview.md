...
```
mlops-dab-demo        <- Root directory. Both monorepo and polyrepo are supported.
│
├── mlops_dab_demo       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
