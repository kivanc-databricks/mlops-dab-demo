...
# ``mlops_dab_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops-dab-demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.mlops-dab-demo.mlops-dab-demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.mlops-dab-demo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.mlops-dab-demo.trip_dropoff_features",
...
param = {"num_leaves": 8, "objective": "regression", "metric": "rmse"}
num_rounds = 30
